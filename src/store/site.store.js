        ...
        samples: {
            sections: [{
                ...
                tree: {
                    type: 'site-section',
                    style: {
                        background: 'url(https://images.unsplash.com/photo-1506104489822-562ca25152fe?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1349&q=80) no-repeat center center fixed',
        ...
        site: {
            ...
            cmps: [{
                ...
                },
                {
                    ...
                    cmps: [{
                            type: 'site-text',
                            content: 'On earth there is no heaven, but there are pieces of it and we will get you there',
                            style: {
                                fontSize: '3rem',
                                width: '43rem',
                                fontWeight: 'bold',
